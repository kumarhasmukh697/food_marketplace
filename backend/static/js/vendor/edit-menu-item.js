...
async function editMenuItem(productId) {
    ...
    try {
        ...
        await fetchCategories("edit-dish-category");
        ...
        document.getElementById("edit-available").checked = Boolean(product.is_available);
        ...
        document.getElementById( "edit-dish-veg").checked = Boolean(product.is_veg);
        ...
        if ( product.category !== undefined) {
            ...
            if ( product.category !== null && typeof product.category === "object"
            ) {
        ...
        const imagePreview = document.getElementById( "edit-profile-preview");
        const imageName = document.getElementById("edit-profile-picture-name");
        ...
        if (product.image) {
            ...
            imagePreview.src = "";
            imageName.textContent ="PNG, JPG, supported";
